      ...
      appBar: PreferredSize(
        ...
        child: Obx(
          () => CommonAppBarWidget(
            ...
            actions: [
              IconButton(onPressed: () {}, icon: const Icon(Icons.call_rounded, color: kColorText)),
              IconButton(onPressed: () {}, icon: const Icon(Icons.videocam_rounded, color: kColorText)),
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: kColorBackground, shape: BoxShape.circle),
          ...
          GestureDetector(
            ...
            child: Container(
               ...
               decoration: const BoxDecoration(color: kColorPrimary, shape: BoxShape.circle),
