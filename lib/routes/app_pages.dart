...
import '../app/user_flow/agency_pending_hosts/bindings/agency_pending_hosts_binding.dart';
import '../app/user_flow/agency_pending_hosts/views/agency_pending_hosts_view.dart';
...
import '../app/user_flow/live_room/bindings/live_room_binding.dart';
import '../app/user_flow/live_room/views/join_live_view.dart';
...
import '../app/user_flow/messages/chat_voice_call/views/chat_voice_call_view.dart';
...
class AppPages {
  ...
  static final routes = <GetPage<dynamic>>[
    ...
    GetPage(
      name: _Paths.AGENCY_PENDING_HOSTS,
      page: () => const AgencyPendingHostsView(),
      binding: AgencyPendingHostsBinding(),
    ),
    GetPage(
    ...
    GetPage(
      name: _Paths.JOIN_LIVE,
      page: () => const JoinLiveView(),
    ...
    GetPage(
      name: _Paths.CHAT_VOICE_CALL,
      page: () => const ChatVoiceCallView(),
      binding: ChatVoiceCallBinding(),
    ),
    GetPage(
