...
> [!NOTE]
> This summary file has been unified and superseded by the comprehensive **`API_DOCUMENTATION.md`** file located in the root directory.

To prevent out-of-sync copies and maintain a single source of truth for the backend team, please refer to:

👉 **[API_DOCUMENTATION.md](file:///Users/onlymac/Documents/Projects/qobo_one_live/API_DOCUMENTATION.md)**

### What you will find in the main document:
1.  **Standard Envelope Specification:** Detailed explanation of the `{statusCode, message, data}` envelopes.
